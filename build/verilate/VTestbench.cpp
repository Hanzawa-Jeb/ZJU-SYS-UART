...
VTestbench::VTestbench(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , __PVT__Testbench__DOT__genblk1__DOT__loop_test__DOT__uart_tdata{vlSymsp->TOP.__PVT__Testbench__DOT__genblk1__DOT__loop_test__DOT__uart_tdata}
    , __PVT__Testbench__DOT__genblk1__DOT__loop_test__DOT__uart_rdata{vlSymsp->TOP.__PVT__Testbench__DOT__genblk1__DOT__loop_test__DOT__uart_rdata}
    , __PVT__Testbench__DOT__genblk1__DOT__loop_test__DOT__uart_unit__DOT__uart_txd{vlSymsp->TOP.__PVT__Testbench__DOT__genblk1__DOT__loop_test__DOT__uart_unit__DOT__uart_txd}
    , __PVT__Testbench__DOT__genblk1__DOT__loop_test__DOT__uart_unit__DOT__uart_rxd{vlSymsp->TOP.__PVT__Testbench__DOT__genblk1__DOT__loop_test__DOT__uart_unit__DOT__uart_rxd}
    , rootp{&(vlSymsp->TOP)}
{
